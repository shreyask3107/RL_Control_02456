...
def parse_args():
	...
	# eval
	parser.add_argument('--save_freq', default='100k', type=str)  # k is later replaced in the code
	...
	parser.add_argument('--pretrain_dir', default='logs/walker_stand/sac/0/model') # Exact directory to the model should be given
	parser.add_argument('--pretrain_task_name', default='stand') # Task from which pretraining takes place
	parser.add_argument('--pretrain_steps', default=500000) # Number of steps (for checkpoint choice)

	parser.add_argument('--depth', default=False) # Number of steps (for checkpoint choice)
